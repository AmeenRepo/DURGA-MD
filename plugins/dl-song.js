...
var handler = async (m, { conn, command, text, usedPrefix }) => {
  if (!text) throw `Use example ${usedPrefix}${command} hamnava mere `; // Add "music" at the end to specify that it's music.

  await m.reply('*⬇️durga md Downloading Your Song🎧*');
  ...
  await m.reply('*⬆️durga md Uploading Your Song🎧*');
